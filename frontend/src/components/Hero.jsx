    ...
    >
      <div className="container-site grid items-center gap-10 sm:gap-12 lg:grid-cols-2">
        ...
        <div className="animate-fade-in-up">
          <span className="badge badge-level mb-4">Learn · Grow · Succeed</span>
          <h1 className="text-4xl font-extrabold leading-tight sm:text-5xl lg:text-6xl">
            Learn with <span className="text-german-red">Joy</span>
          </h1>
        ...
        <div className="relative animate-fade-in lg:justify-self-end">
          ...
          <EditableImage
            src={trainer?.photo}
            alt="Learners studying together in a course"
            label="course image"
