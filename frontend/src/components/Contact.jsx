    ...
    <section id="contact" className="bg-slate-50 py-16 sm:py-20">
      <div className="container-site">
        ...
        <p className="section-subtitle">
              Questions about courses, learning plans or enrollment? Send a message or request a call back — no sign-in
          required.
        </p>
        ...
        <div className="mt-10 grid gap-8 sm:mt-12 sm:gap-10 lg:grid-cols-5">
          ...
          <div className="space-y-4 lg:col-span-2">
            ...
            <p className="text-center text-xs text-slate-400">
              Just your name & number — the Instructor/Trainer will call you. No sign-in needed.
            </p>
          </div>
      ...
      {showCallback && (
        ...
        >
          ...
          >
            ...
            <p className="mt-1 text-sm text-slate-500">Leave your number and the Instructor/Trainer will call you back — no account needed.</p>
