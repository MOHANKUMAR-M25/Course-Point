  ...
  return (
    <section id="testimonials" className="py-16 sm:py-20">
      <div className="container-site">
        ...
        <p className="section-subtitle">Real journeys from learners who transformed their skills and confidence.</p>
          ...
          {testimonials.map((t) => (
            <figure key={t.id} className="card relative flex flex-col !p-8">
              ...
              <figcaption className="mt-6 flex items-center gap-4 border-t border-slate-100 pt-5">
                <img
                  src={t.photo || "https://via.placeholder.com/80?text=Photo"}
                  alt={t.name}
                  className="h-12 w-12 shrink-0 rounded-full object-cover ring-2 ring-german-gold/50"
                  loading="lazy"
                />
                <div>
