    ...
    <section id="about" className="py-16 sm:py-20">
      <div className="container-site">
        <h2 className="section-title">
          About <span>Course Point</span>
        </h2>
        <p className="section-subtitle">A practical learning platform built to help every learner move forward with confidence.</p>
        ...
        <div className="mt-12 grid gap-10 lg:grid-cols-5">
          ...
          <div className="lg:col-span-2">
            <div className="card !p-8">
              <h3 className="font-display text-lg font-bold">Why choose Course Point?</h3>
