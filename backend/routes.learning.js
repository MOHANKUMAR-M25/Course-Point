...
export function registerLearningRoutes(app, { requireAdmin, requireStudent, adminEmails, sendNotificationEmail }) {
  ...
  router.post(
    ...
    wrap(async (req, res) => {
      ...
      // Tell the Instructor/Trainer there's something to grade.
  ...
  router.post(
    ...
    wrap(async (req, res) => {
      ...
      res.json({
        success: true,
        message: "Request sent! The Instructor/Trainer has been notified and will add the questions soon."
      });
    })
  );
